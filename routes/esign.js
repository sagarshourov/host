...
// Routes
router.post('/', createEsignDocument);
router.get('/', getAllEsignDocuments);
router.get('/:id', getEsignDocumentById);
router.put('/:id', updateEsignDocument);
router.delete('/:id', deleteEsignDocument);
